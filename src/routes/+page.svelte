...
<script lang="ts">
	...
	let { data }: { data: { aufgaben: Aufgabe[] } } = $props();
...
<div class="hub">
	<header class="hub-header">
		<h1 class="hub-titel">Rezeptbuch</h1>
		<p class="hub-unter">Deine Küchen-Zentrale</p>
	</header>
...
<section class="planer">
	<div class="planer-kopf">
		<h2 class="planer-titel">Haushaltsaufgaben</h2>
		<div class="planer-steuerung">
			<div class="ansicht-toggle">
				...
				<button
					...
					onclick={() => (ansicht = 'monat')}>Monat</button
				>
			</div>
